...
action.addEventListener('click',() =>{
  let filteredMovies = movies.filter(movie =>movie.category === 'Action')
  showData(filteredMovies)
});


thriller.addEventListener('click',() =>{
  let filteredMovies = movies.filter(movie =>movie.category === 'Thriller')
  showData(filteredMovies)
});

animation.addEventListener('click',() =>{
  let filteredMovies = movies.filter(movie =>movie.category === 'Animation')
  showData(filteredMovies)
});

horror.addEventListener('click',() =>{
  let filteredMovies = movies.filter(movie =>movie.category === 'Horror')
  showData(filteredMovies)
});

drama.addEventListener('click',() =>{
  let filteredMovies = movies.filter(movie =>movie.category === 'Drama')
  showData(filteredMovies)
});

sci_fi.addEventListener('click',() =>{
  let filteredMovies = movies.filter(movie =>movie.category === 'Sci-Fi')
  showData(filteredMovies)
});
